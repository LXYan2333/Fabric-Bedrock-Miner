...
public class BlockBreaker {
    public static ArrayList<Block> blocksOfInterest = new ArrayList(List.of(new Block[]{Blocks.BEDROCK, Blocks.END_PORTAL_FRAME, Blocks.END_PORTAL, Blocks.OBSIDIAN}));
